                        ...
                        geojson.features.forEach(feature => {
                            if (feature.geometry && feature.geometry.coordinates) {
                                try {
                                    ...
                                    console.error("Erro ao reprojetar coordenada:", feature.geometry.coordinates, e);
                                }
                            }
                        });
                            ...
                            geojson.features.forEach(feature => {
                                if (feature.geometry && feature.geometry.coordinates) {
                                    try {
                                        ...
                                        console.error("Erro ao reprojetar coordenada do cache:", feature.geometry.coordinates, e);
                                    }
                                }
                            });
