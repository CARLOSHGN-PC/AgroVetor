...
  // [NOVO] Rota para relatório de monitoramento em PDF
...
        if (fazendaCodigo) {
            // Esta é uma simplificação. O ideal seria ter o código da fazenda na armadilha.
            // Por enquanto, não filtraremos por fazenda no backend para este relatório.
        }
...
        const headers = ['Data Instalação', 'Data Coleta', 'Mariposas', 'Latitude', 'Longitude'];
        const columnWidths = [120, 120, 100, 180, 180];
        const rowHeight = 18;
        const textPadding = 5;
...
  // [NOVO] Rota para relatório de monitoramento em CSV
