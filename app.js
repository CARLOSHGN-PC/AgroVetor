    ...
    const App = {
        ...
        auth: {
            ...
            async login() {
                ...
                try {
                    // Garante que a sessão do usuário persista no dispositivo.
                    // Isso é essencial para o funcionamento offline e para que a sincronização funcione
                    // corretamente após o aplicativo ser fechado e reaberto.
